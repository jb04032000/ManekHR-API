...
export class Proforma extends Document {
  ...
  @Prop({ type: String, default: 'proforma' })
  voucherType: string;
  ...
  @Prop({
    type: String,
    enum: ['open', 'converted', 'expired', 'cancelled'],
    default: 'open',
  })
...
ProformaSchema.index({ workspaceId: 1, firmId: 1, voucherDate: -1 });
ProformaSchema.index({ workspaceId: 1, firmId: 1, voucherNumber: 1 });
