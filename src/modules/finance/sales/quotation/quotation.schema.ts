...
export class Quotation extends Document {
  ...
  @Prop({ type: String, default: 'quotation' })
  voucherType: string;
...
QuotationSchema.index({ workspaceId: 1, firmId: 1, voucherDate: -1 });
QuotationSchema.index({ workspaceId: 1, firmId: 1, voucherNumber: 1 });
