 ...
 *
 * Thin re-exporter: delegates to checkC01Common from Plan 12-04 gstr1/checks/common.ts.
 * No logic duplication.
 */
export async function checkC01(deps: CheckDeps): Promise<VerifyDataFinding[]> {
  ...
  return checkC01Common(commonDeps);
}
